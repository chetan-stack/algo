...
def place_order(product_id, size, side):
    ...
    if side == 'buy':
         ...
         order_data = {
             ...
             'order_type': 'market_order',
             'side': 'sell',
             "reduce_only": True         # Ensure this closes, not opens
...
# place_order(85248, 10, 'sell')

# url = f"https://cdn.india.deltaex.org/v2/tickers/P-BTC-117800-200725"
# response = requests.get(url)
# # print(response)
# ticker_info = response.json()
# print(ticker_info['result']['product_id'])
